...
## Purpose
Defines serialized storage types (headers, tx hashes, receipts, logs) and encoding helpers, and
...
- **Types**: `BlockBundle`, `StoredTxHashes`, `StoredTransactions`, `StoredReceipts`, `StoredLog`, `StorageDiskStats`, `StoredPeer`
